...
$hotels = [
    ...
    [
        ...
        'url' => '/images/hotels/marina1.jpg',
        'desc' => 'У Сінгапурі рік тому відкрився готель для любителів гострих відчуттів - Marina Bay Sands. На трьох вежах висотою в 200 метрів (55 поверхів) розташовується величезна тераса у вигляді гондоли з басейнами і зеленими садами загальною площею 12,4 тис. кв. метрів. Головний басейн, розташований під відкритим небом, не має видимих бортиків, через що створюється враження, що кромка води обривається на висоті (так званий нескінченний басейн). Басейн тягнеться на 150 метрів і є найбільшим басейном, побудованим на такій висоті. У готелі - 2500 номерів, торговий центр, конференц-зал, два театри, один музей і кілька ресторанів. Споруда готелю обійшлася в 5,7 мільярда доларів.'
    ],
    [
        'title' => 'Готель Burj Al Arab Дубаї, Арабські Емірати',
        'url' => '/images/hotels/dubai.jpg',
